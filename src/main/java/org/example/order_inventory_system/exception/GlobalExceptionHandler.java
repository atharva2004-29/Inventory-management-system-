...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(CustomerException.NotFoundException.class)
    public ResponseEntity<Map<String, Object>> handleCustomerNotFound(
            CustomerException.NotFoundException ex) {
    ...
    @ExceptionHandler(CustomerException.AlreadyExistsException.class)
    public ResponseEntity<Map<String, Object>> handleCustomerAlreadyExists(
            CustomerException.AlreadyExistsException ex) {
    ...
    // ✅ Validation errors (@NotBlank, @Email) — 400
